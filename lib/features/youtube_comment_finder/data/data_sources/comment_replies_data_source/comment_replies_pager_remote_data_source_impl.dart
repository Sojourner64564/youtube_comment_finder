...
class CommentRepliesPagerRemoteDataSourceImpl implements CommentRepliesPagerRemoteDataSource{
  ...
  Future<CommentRepliesModel> fetchReplies(CommentRepliesParams commentRepliesParams) async {
    final response = await http.get(Uri.parse(
      'https://youtube.googleapis.com/youtube/v3/comments?key=AIzaSyAwN8yc4ittxrac_rhW4swd63odvZbHRD8&part=snippet&parentId=${commentRepliesParams
          .parentId}&pageToken=${commentRepliesParams.pageToken}',
    ));
